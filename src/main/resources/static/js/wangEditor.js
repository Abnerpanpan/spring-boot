...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        if (textSelector == null) {
            ...
            // 自行创建的，需要配置默认的样式
            $toolbarElem.css('background-color', '#fff').css('border-bottom', '1px solid #8590A6')
                .css("border-top-right-radius","5px").css("border-top-left-radius","5px").css("font-size","16px")
                .css("height","40px").css("line-height","40px");
        ...
        // 编辑区域
        $textElem = $('<div></div>');
        $textElem.attr('contenteditable', 'true').css('width', '100%').css('height', '100%').css('overflow','auto');
